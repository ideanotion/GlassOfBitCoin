...
//	            doBindService();
	            ...
	            if (resultCode == RESULT_OK) {
	                ...
	                if(data != null) {
	                    ...
	                    if(extras != null) {
	                        ...
	                        Log.i("bitcoin cam Before baseApi");
	                        Log.i("bitcoin cam thumbnailFilePath = " + thumbnailFilePath);
	                        Log.i("bitcoin cam pictureFilePath = " + pictureFilePath);
	                        try{
	                		...
	                		Log.i("BitCoin recoginze: "+recognizedText);
	                		baseApi.end();
	    ...
	    private void readCardAloud(String voiceAction)
	    {
	    	...
	    	try{
		        ...
		        result_num = Math.round(result_num * 1000.0) / 1000.0;
		        String final_string = String.valueOf(result_num);
		        Log.i("bitcoin voice speaking:"+final_string);
		        String headingText = "Bitcoin value of $"+transfer_number+"\n is "+final_string;
		    	mSpeech.speak(headingText, TextToSpeech.QUEUE_FLUSH, null);  
		    	//headingText = "Bitcoin value of $"+curBitValue+"\n is "+final_string;
		    	updateCard(headingText);
		    } catch (Exception e) {
		    	
		    	Log.i("bitcoin voice exception:"+e);
		    	String headingText = "Error, tap to retake picture.";//"Input:"+voiceAction+". Bitcoin value is:"+curBitValue;
		    	//mSpeech.speak(headingText, TextToSpeech.QUEUE_FLUSH, null); 
		    	updateCard(headingText);
		    }
