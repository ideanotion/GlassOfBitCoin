...
public class SelectValueActivity extends Activity implements GestureDetector.BaseListener {
    ...
    public boolean onGesture(Gesture gesture) {
        ...
        if (gesture == Gesture.TAP) {
        	Log.i("bitcoint ongesture - tap");
            Intent resultIntent = new Intent();
            int curPost=mView.getSelectedItemPosition();
            resultIntent.putExtra(EXTRA_SELECTED_VALUE, curPost);
            BitCoinOfGlassConstants.CUR_POS=curPost;
            Log.i("bitcoin cur pos: "+BitCoinOfGlassConstants.CUR_POS);
